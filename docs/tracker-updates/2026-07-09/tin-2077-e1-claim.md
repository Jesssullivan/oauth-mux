...
keepalive is proven (`v0.1.14`), but seamless managed hot-swap between
Claude accounts is not, and stays a non-claim until TIN-2721 produces live
proof under TIN-2077's per-profile isolation constraints.

References: Linear TIN-2077 (parent), TIN-2721 (new, E1 experiment).
