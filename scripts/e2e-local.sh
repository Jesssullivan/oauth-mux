...
expect_contains "$stay_next" '"resilience":{"selected_route_ready":true,"selectable_fallback_routes":0,"recoverable_fallback_routes":1,"spare_fallback_ready":false,"single_route_at_risk":true,"recovery_window_resets_at":' "stay-afloat next reports no spare fallback with recoverable quota route"
...
expect_contains "$daemon_tick" '"resilience":{"selected_route_ready":true,"selectable_fallback_routes":0,"recoverable_fallback_routes":1,"spare_fallback_ready":false,"single_route_at_risk":true,"recovery_window_resets_at":' "daemon tick reports no spare fallback with recoverable quota route"
...
expect_contains "$broker_route_explain_after_drill" '"resilience":{"selected_route_ready":true,"selectable_fallback_routes":0,"recoverable_fallback_routes":' "route explain after drill exposes no-spare Codex state with recoverable quota accounting"
expect_contains "$broker_route_explain_after_drill" '"spare_fallback_ready":false,"single_route_at_risk":true,"recovery_window_resets_at":' "route explain after drill exposes recoverable quota reset"
...
expect_contains "$broker_stay_afloat_after_drill" '"resilience":{"selected_route_ready":true,"selectable_fallback_routes":0,"recoverable_fallback_routes":' "stay-afloat after drill exposes no-spare Codex state with recoverable quota accounting"
expect_contains "$broker_stay_afloat_after_drill" '"spare_fallback_ready":false,"single_route_at_risk":true,"recovery_window_resets_at":' "stay-afloat after drill exposes recoverable quota reset"
